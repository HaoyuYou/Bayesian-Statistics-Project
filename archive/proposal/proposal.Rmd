...
> Historical proposal: this bike-sharing topic was superseded by the Ames housing
> project. See the repository README for the final scope and results.
...
```{r main}
bike <- read.csv("archive/proposal/data/day.csv")
...
```{r}
bmw <- read.csv("archive/proposal/data/bmw_global_sales_2018_2025.csv")
head(bmw)
```
### URL: 
